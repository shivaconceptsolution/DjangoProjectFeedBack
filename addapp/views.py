...
def feedlogic(request):
	obj = Feedback(feedby=request.POST["txtemail"],feedto=request.POST["txtfeedto"],feeddesc=request.POST["txtfeeddesc"],feedbackrate=request.POST["txtfeedrate"])
	obj.save()
	return redirect("viewreg")